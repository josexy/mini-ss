export namespace config {
	...
	export class LocalJsonConfig {
	    ...
	    static createFrom(source: any = {}) {
	        return new LocalJsonConfig(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.udp_tun_addr = source["udp_tun_addr"];
	...
	export class ServerJsonConfig {
	    ...
	    static createFrom(source: any = {}) {
	        return new ServerJsonConfig(source);
	    }
	...
	export class JsonConfig {
	    ...
	    static createFrom(source: any = {}) {
	        return new JsonConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.server = this.convertValues(source["server"], ServerJsonConfig);
	        this.local = this.convertValues(source["local"], LocalJsonConfig);
